...
export class TankController {
    ...
    private static bulletController = new BulletController();
    ...
    public static shootBullet() {
        ...
        if (this.tank.bulletType == BulletType.Shotgun || this.tank.bulletType == BulletType.SuperShotgun) {
            if (this.tank.bulletType == BulletType.Shotgun) {
                this.bulletController.shootShotgun(this.bullets, this.tank.position, this.scopePos, this.cannonRotation, "player", "playerBullet"+this.cont, 3)
            } else {
                this.bulletController.shootShotgun(this.bullets, this.tank.position, this.scopePos, this.cannonRotation, "player", "playerBullet"+this.cont, 5)
            }
        } else if (this.tank.bulletType == BulletType.Rafagas || this.tank.bulletType == BulletType.SuperRafagas) {
            this.bulletController.shootRafagas(this.bullets, this.tank.position, this.scopePos, this.cannonRotation, "player", "playerBullet"+this.cont)
        } else if (this.tank.bulletType == BulletType.SuperSubfusil) {
            this.bulletController.shootSuperSubfusil(this.bullets, this.tank.position, this.scopePos, this.cannonRotation, "player", "playerBullet"+this.cont)
            ...
            if (this.tank.bulletType == BulletType.Tortuga) {
                this.bulletController.shootTurtle(this.bullets, this.tank.position, this.scopePos, "player", "playerBullet"+this.cont, -0.75)
            } else {
                this.bulletController.shootTurtle(this.bullets, this.tank.position, this.scopePos, "player", "playerBullet"+this.cont, -0.375)
            }
            ...
            this.bulletController.shootSuperNormal(tiro, this.tank.position, this.scopePos, this.cannonRotation, "player", "playerBullet"+this.cont)
            if (TankController.cont > this.bullets.length -1) {
                TankController.cont = 0;
            }
        } else {
            this.bulletController.shoot(this.bullets[this.cont], this.tank.position, this.scopePos, this.cannonRotation, "player", "playerBullet"+this.cont);
            TankController.cont++;
            if (TankController.cont > this.bullets.length -1) {
                TankController.cont = 0;
            }
